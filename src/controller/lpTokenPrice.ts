...
const getEllipsisLPTokenTVLinUSD = async (
  ...
  const supply =
    (Number(token1Amount),
    Number(token2Amount),
    Number(token1Amount.add(token2Amount)));
...
const lpPrice = async () => {
  ...
  let arthUsd3PoolLpPrice =
    (await maticArthUsd3Pool.get_virtual_price()) / 10 ** 18;
  ...
  const maticArthUsdcLpPrice =
    Number(maticArthUsdcTvl.tvlUsd) / Number(maticArthUsdcTvl.supply);
  ...
  const maticArthMahaLpPrice =
    Number(maticArthMahaTvl.tvlUsd) / Number(maticArthMahaTvl.supply);
  ...
  const bscArthBusdLpPrice =
    Number(bscArthBusdTvl.tvlUsd) / Number(bscArthBusdTvl.supply);
  ...
  const bscArthMahaLpPrice =
    Number(bscArthMahaTvl.tvlUsd) / Number(bscArthMahaTvl.supply);
  ...
  const bscArth3epsLpPrice =
    bscArth3epsTVLUsd / (Number(await bscArthUsd3eps.totalSupply()) / 10 ** 18);
