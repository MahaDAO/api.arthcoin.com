import { polygonProvider, ethRinkebyProvider, bscProvider, polygonTestnetProvider, ethProvider } from "../web3";
...
const getRewardinTVL = async (
    ...
    const rewardTokenBalance: BigNumber = await rewardContract.balanceOf(guageAddress);
